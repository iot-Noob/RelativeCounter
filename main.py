...
async def data_view(
    ...
    try:
        ...
        return HTTPException(400,f"Error read file due to {e}")
...
async def count_guests(file_name: List[str] = Query(..., title="Name of CSV files", description="List of CSV files to process")):
    total_guests = 0
    file_data = {}
